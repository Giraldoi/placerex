  ...
  <div class="container p-4">
    <div class="row">
      <div class="col-lg-3 col-md-6 mb-4">
        <h5 class="mb-3" style="letter-spacing: 2px; color: #7f4722;">Placerex</h5>
        <ul class="list-unstyled mb-0">
          <li class="mb-1">
            <a href="#!" style="color: #4f4f4f;">Derechos de autor</a>
          </li>
          <li class="mb-1">
            <a href="#!" style="color: #4f4f4f;">Fuentes</a>
          </li>
          <li class="mb-1">
            <a href="#!" style="color: #4f4f4f;">preguntas</a>
          </li>
          <li>
            <a href="#!" style="color: #4f4f4f;">Reclamos</a>
          </li>
        </ul>
      </div>
      <div class="col-lg-3 col-md-6 mb-4">
        <h5 class="mb-3" style="letter-spacing: 2px; color: #7f4722;">Líneas ayuda</h5>
        <ul class="list-unstyled mb-0">
          <li class="mb-1">
            <a href="#!" style="color: #4f4f4f;">Secretaría de la mujer</a>
          </li>
          <li class="mb-1">
            <a href="#!" style="color: #4f4f4f;"></a>
          </li>
          <li class="mb-1">
            <a href="#!" style="color: #4f4f4f;">Línea amiga</a>
          </li>
          <li>
            <a href="#!" style="color: #4f4f4f;"></a>
          </li>
          <li>
            <a href="#!" style="color: #4f4f4f;">Policia Nacional</a>
          </li>
        </ul>
      </div>
      <div class="col-lg-3 col-md-6 mb-4">
        <h5 class="mb-3" style="letter-spacing: 2px; color: #7f4722;">Contacto</h5>
        <ul class="list-unstyled mb-0">
          <li class="mb-1">
            <a href="#!" style="color: #4f4f4f;">018000112137</a>
          </li>
          <li class="mb-1">
            <a href="#!" style="color: #4f4f4f;">WhatsApp 3007551846</a>
          </li>
          <li class="mb-1">
            <a href="#!" style="color: #4f4f4f;">444 44 48</a>
          </li>
          <li>
            <a href="#!" style="color: #4f4f4f;">123</a>
          </li>
        </ul>
      </div>
      <div class="col-lg-3 col-md-6 mb-4">
        <h5 class="mb-3" style="letter-spacing: 2px; color: #7f4722;">Links</h5>
        <ul class="list-unstyled mb-0">
          <li class="mb-1">
            <a href="#!" style="color: #4f4f4f;">https://www.sdmujergov.co</a>
          </li>
          <li class="mb-1">
            <a href="#!" style="color: #4f4f4f;">https://www.medellin.gov.co</a>
          </li>
            <a href="#!" style="color: #4f4f4f;">https://www.policia.gov.co</a>
        </ul>
      </div>
    </div>
  </div>
